...
class Texture
{
    ...
    {
        if (Std.is(data, Bitmap))  data = (data : Bitmap).bitmapData;
                                           ...
                                           options:TextureOptions=null):ConcreteTexture
    {
        ...
        {
            return new ConcretePotTexture(cast base,
        ...
        {
            return new ConcreteRectangleTexture(cast base,
        ...
        {
            return new ConcreteVideoTexture(cast base, options.scale);
        }
        #end
        else
                                 ...
                                 forcePotTexture:Bool=false):Texture
    {
        ...
        if (useRectTexture)
        {
            ...
            concreteTexture = new ConcreteRectangleTexture(
                    cast nativeTexture, format, actualWidth, actualHeight,
    ...
    @:noCompletion private function get_frameWidth():Float { return frame != null ? frame.width : width; }

    /** The width of the texture in points, taking into account the frame rectangle
     *  (if there is one). */
    public var frameHeight(get, never):Float;
    @:noCompletion private function get_frameHeight():Float { return frame != null ? frame.height : height; }

    /** The width of the texture in points. */
    public var width(get, never):Float;
    @:noCompletion private function get_width():Float { return 0; }

    /** The height of the texture in points. */
    public var height(get, never):Float;
    @:noCompletion private function get_height():Float { return 0; }

    /** The width of the texture in pixels (without scale adjustment). */
    public var nativeWidth(get, never):Float;
    @:noCompletion private function get_nativeWidth():Float { return 0; }

    /** The height of the texture in pixels (without scale adjustment). */
    public var nativeHeight(get, never):Float;
    @:noCompletion private function get_nativeHeight():Float { return 0; }

    /** The scale factor, which influences width and height properties. */
    public var scale(get, never):Float;
    @:noCompletion private function get_scale():Float { return 1.0; }

    /** The Stage3D texture object the texture is based on. */
    public var base(get, never):TextureBase;
    @:noCompletion private function get_base():TextureBase { return null; }

    /** The concrete texture the texture is based on. */
    public var root(get, never):ConcreteTexture;
    @:noCompletion private function get_root():ConcreteTexture { return null; }

    /** The <code>Context3DTextureFormat</code> of the underlying texture data. */
    public var format(get, never):Context3DTextureFormat;
    @:noCompletion private function get_format():Context3DTextureFormat { return Context3DTextureFormat.BGRA; }

    /** Indicates if the texture contains mip maps. */
    public var mipMapping(get, never):Bool;
    @:noCompletion private function get_mipMapping():Bool { return false; }

    /** Indicates if the alpha values are premultiplied into the RGB values. */
    public var premultipliedAlpha(get, never):Bool;
    @:noCompletion private function get_premultipliedAlpha():Bool { return false; }
    ...
    @:noCompletion private function get_transformationMatrix():Matrix { return null; }
    ...
    @:noCompletion private function get_transformationMatrixToRoot():Matrix { return null; }
    ...
    @:noCompletion private static function get_maxSize():Int
    {
