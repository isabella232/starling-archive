...
class VertexData
{
    ...
    public function new(format:Dynamic=null, initialCapacity:Int=32)
    {
        ...
        else if (Std.is(format, String)) _format = VertexDataFormat.fromString(cast format);
            ...
            vertexID:Int, numVertices:Int):Void
    {
        ...
        if (matrix != null)
        {
            ...
            {
                var x:Float = sourceData.readFloat();
                var y:Float = sourceData.readFloat();
    ...
    @:noCompletion private function set_premultipliedAlpha(value:Bool):Bool
    {
    ...
    @:noCompletion private function get_format():VertexDataFormat
    {
        return _format;
    }

    @:noCompletion private function set_format(value:VertexDataFormat):VertexDataFormat
    {
    ...
    @:noCompletion private function get_formatString():String
    {
    ...
    @:noCompletion private function get_vertexSizeIn32Bits():Int
    {
    ...
    @:noCompletion private function get_sizeIn32Bits():Int
    {
